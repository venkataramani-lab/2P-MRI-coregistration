 ...
 * 
 * This macro expects 7 channel tif: Channel 1 2P timepoint 1, channel 2 MRI timepoint 1, 
 * channel 3 2P timepoint 2, channel 4 MRI timepoint 2, channel 5 2P timepoint 3, 
 * channel 6 MRI timepoint 3, channel 7 mask.
		...
		if (endsWith(fileList[n], '.tiff') || endsWith(fileList[n], '.tif')) {
            ...
            if (channels == 7) {
				...
				for (l = 0; l < arraySize.length; l++) {
					...
					print(arraySizeC1[l] + "\t" + arraySizeC2[l] + "\t" + arraySizeC3[l] + "\t" + arraySizeC4[l]  + "\t" + arraySizeC5[l] + "\t" + arraySizeC6[l] + "\t" + arraySizeC7[l] + "\t" + title + "\t" + (n+1) + "\t" + l + "\t" + info_z[l] + "\t" + info_x[l] + "\t" + info_y[l]);
				...
				exit("Input image must have 7 channels");
